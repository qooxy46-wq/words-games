// 单词数据
// 硅谷大佬建议：用对象(Object)来管理多课数据，清晰且易扩展
const allLessons = {
  1: [
  ...
  2: [
    { id: 1, word: 'cheek', chinese: '脸颊', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/cheek--_gb_1.mp3', image: 'images/lesson2/cheek.png' },
    { id: 2, word: 'hair', chinese: '头发', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/hair--_gb_1.mp3', image: 'images/lesson2/hair.png' },
    { id: 3, word: 'elbow', chinese: '手肘', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/elbow--_gb_1.mp3', image: 'images/lesson2/elbow.png' },
    { id: 4, word: 'hands', chinese: '手', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/hand--_gb_1.mp3', image: 'images/lesson2/hands.png' },
    { id: 5, word: 'knees', chinese: '膝盖', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/knee--_gb_1.mp3', image: 'images/lesson2/knees.png' },
    { id: 6, word: 'mouth', chinese: '嘴巴', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/mouth--_gb_1.mp3', image: 'images/lesson2/mouth.png' },
    { id: 7, word: 'shoulders', chinese: '肩膀', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/shoulder--_gb_1.mp3', image: 'images/lesson2/shoulders.png' },
    { id: 8, word: 'teeth', chinese: '牙齿', audio: 'https://ssl.gstatic.com/dictionary/static/sounds/20200429/teeth--_gb_1.mp3', image: 'images/lesson2/teeth.png' }
  ]
};

// 关键改动：让 vocabulary 变成一个可以随时被替换的变量
let vocabulary = [...allLessons[1]]; 

// 新增：选关功能函数
function selectLesson(num) {
    vocabulary = [...allLessons[num]];
    // 更新按钮颜色和提示
    document.getElementById('btn-l1').style.backgroundColor = (num === 1 ? '#27AE60' : '#9E9E9E');
    document.getElementById('btn-l2').style.backgroundColor = (num === 2 ? '#27AE60' : '#9E9E9E');
    document.getElementById('selected-hint').textContent = "Current: Lesson " + num;
    // 重置游戏状态
    restartGame();
    console.log("Switched to Lesson " + num);
};
