// 单词数据
const vocabulary = [
  { id: 1, word: 'elbow', chinese: '胳膊肘', audio: 'https://dict.youdao.com/dictvoice?audio=elbow&type=2', image: 'elbow.png' },
  { id: 2, word: 'cheek', chinese: '脸颊', audio: 'https://dict.youdao.com/dictvoice?audio=cheek&type=2', image: 'cheek.png' },
  { id: 3, word: 'hands', chinese: '手', audio: 'https://dict.youdao.com/dictvoice?audio=hands&type=2', image: 'hands.png' },
  { id: 4, word: 'teeth', chinese: '牙齿', audio: 'https://dict.youdao.com/dictvoice?audio=teeth&type=2', image: 'teeth.png' },
  { id: 5, word: 'shoulders', chinese: '肩膀', audio: 'https://dict.youdao.com/dictvoice?audio=shoulders&type=2', image: 'shoulders.png' },
  { id: 6, word: 'knees', chinese: '膝盖', audio: 'https://dict.youdao.com/dictvoice?audio=knees&type=2', image: 'knees.png' },
  { id: 7, word: 'mouth', chinese: '嘴', audio: 'https://dict.youdao.com/dictvoice?audio=mouth&type=2', image: 'mouth.png' },
  { id: 8, word: 'finger', chinese: '手指', audio: 'https://dict.youdao.com/dictvoice?audio=finger&type=2', image: 'finger.png' },
  { id: 9, word: 'hair', chinese: '头发', audio: 'https://dict.youdao.com/dictvoice?audio=hair&type=2', image: 'hair.png' }
];
