// 单词数据
const vocabulary = [
 { id: 1, word: 'ice cream', chinese: '冰淇淋', audio: 'https://dict.youdao.com/dictvoice?audio=ice cream&type=1', image: '../image/lesson11/ice cream.png' },
  { id: 2, word: 'soup', chinese: '汤', audio: 'https://dict.youdao.com/dictvoice?audio=soup&type=1', image: '../image/lesson11/soup.png' },
  { id: 3, word: 'banana', chinese: '香蕉', audio: 'https://dict.youdao.com/dictvoice?audio=banana&type=1', image: '../image/lesson11/banana.png' },
  { id: 4, word: 'watermelon', chinese: '西瓜', audio: 'https://dict.youdao.com/dictvoice?audio=watermelon&type=1', image: '../image/lesson11/watermelon.png' },
  { id: 5, word: 'pizza', chinese: '披萨', audio: 'https://dict.youdao.com/dictvoice?audio=pizza&type=1', image: '../image/lesson11/pizza.png' },
  { id: 6, word: 'popcorn', chinese: '爆米花', audio: 'https://dict.youdao.com/dictvoice?audio=popcorn&type=1', image: '../image/lesson11/popcorn.png' },
  { id: 7, word: 'broccoli', chinese: '西兰花', audio: 'https://dict.youdao.com/dictvoice?audio=broccoli&type=1', image: '../image/lesson11/broccoli.png' },
  { id: 8, word: 'donut', chinese: '甜甜圈', audio: 'https://dict.youdao.com/dictvoice?audio=donut&type=1', image: '../image/lesson11/donut.png' },
  { id: 9, word: 'juice', chinese: '果汁', audio: 'https://dict.youdao.com/dictvoice?audio=juice&type=1', image: '../image/lesson11/juice.png' }
];
